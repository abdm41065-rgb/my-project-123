...
<head>
  ...
  <style>
    ...
    *{box-sizing:border-box}
    ...
    body{padding:18px}
    .shell{max-width:1240px;margin:0 auto;display:grid;gap:16px}
    ...
    .chart-area{height:360px;position:relative;margin-top:12px}
  ...
  <div class="shell">
    <div class="topbar">
      ...
      <div class="tabs" id="mainTabs">
        ...
        <button class="tab" data-section="personal">المالية الشخصية</button>
        ...
        <div>
          <div class="flex" style="justify-content:space-between;align-items:flex-start">
            ...
            <div class="links">
              ...
              <button class="btn" data-jump="personal"><i class="fa-solid fa-wallet icon"></i>انتقال للمالية الشخصية</button>
            </div>
          </div>
    ...
    <section class="panel" id="personal" aria-label="المالية الشخصية" hidden>
      <div class="layout">
        <div>
          <div class="panel">
            <div class="flex" style="justify-content:space-between;align-items:center">
              <h3>المالية الشخصية</h3>
              <span class="pill">قسم خاص</span>
            </div>
        ...
        <aside>
          ...
          <div class="panel" style="margin-top:12px">
            <div class="flex" style="justify-content:space-between;align-items:center">
              <h4>ملاحظات شخصية مثبتة</h4>
              <span class="pill">قسم خاص</span>
            </div>
            <div class="form-grid">
              <textarea id="noteText" rows="2" placeholder="اكتب ملاحظة مالية أو تذكير مهم"></textarea>
  ...
  <script>
    ...
    function renderPersonal(){
      ...
      [
        ...
        {label:'صافي شخصي', value:fmt(net), tone:'var(--accent)'},
    ...
    document.getElementById('addPersonal').addEventListener('click',()=>{
      ...
      const desc = document.getElementById('ptDesc').value.trim()|| (type==='income'?'دخل شخصي':'مصروف شخصي');
